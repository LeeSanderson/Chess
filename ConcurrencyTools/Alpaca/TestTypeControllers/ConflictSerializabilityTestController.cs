...
{
    class ConflictSerializabilityTestController : TestTypeController
    {

        public ConflictSerializabilityTestController() : base(typeof(ConflictSerializabilityTestEntity)) { }

        internal override IEnumerable<AAction> CreateTestActions(AActionContext context)
        {
            // Run Test
            yield return new ARunAllMCutTestCasesAction("Run Conflict Serializability Test");
