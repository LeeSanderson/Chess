...
public:	
	...
	// capture results
	static void ReportError(const char *description, const char *action, const ErrorInfo* errorInfo);
	static void ReportWarning(const char *description, const char *action, bool includeschedule);
    static void CaptureResult(char category, const char *description, const char *actions, bool includeschedule, const ErrorInfo* errorInfo);
